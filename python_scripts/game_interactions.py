def __cricket_score_board__( database, game_id_database, game_data ):
    ...
    current_score_board['overs_completed'] =  game['team_list'][game['active_team']]['ball']
    current_score_board['current_socre'] =  game['team_list'][game['active_team']]['score']
    current_score_board['current_wickets'] =  game['team_list'][game['active_team']]['wickets']
